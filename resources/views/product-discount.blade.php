    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="discount_types[0][title]" value="" placeholder="Buyer Discount">
                </div>
            </div>
            <!-- <div class="form-group">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="hidden" class="form-control" name="discount_types[0][type]" value="buyer" placeholder="buyer" hidden>
            <div class="form-group">
